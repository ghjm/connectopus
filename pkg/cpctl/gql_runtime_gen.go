...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.netns":
		...
		args, err := ec.field_Query_netns_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}
...
func (ec *executionContext) field_Mutation_updateConfig_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	arg0, err := ec.field_Mutation_updateConfig_argsConfig(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["config"] = arg0
...
) (ConfigUpdateInput, error) {
	// We won't call the directive if the argument is null.
	// Set call_argument_directives_with_null to true to call directives
	// even if the argument is null.
	_, ok := rawArgs["config"]
	if !ok {
		var zeroVal ConfigUpdateInput
		return zeroVal, nil
	}

	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("config"))
	if tmp, ok := rawArgs["config"]; ok {
		return ec.unmarshalNConfigUpdateInput2githubᚗcomᚋghjmᚋconnectopusᚋpkgᚋcpctlᚐConfigUpdateInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Query_netns_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	arg0, err := ec.field_Query_netns_argsFilter(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["filter"] = arg0
...
func (ec *executionContext) field_Query_netns_argsFilter(
	ctx context.Context,
	rawArgs map[string]interface{},
) (*NetnsFilter, error) {
	// We won't call the directive if the argument is null.
	...
	_, ok := rawArgs["filter"]
	if !ok {
		var zeroVal *NetnsFilter
		return zeroVal, nil
	}

	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("filter"))
	if tmp, ok := rawArgs["filter"]; ok {
		return ec.unmarshalONetnsFilter2ᚖgithubᚗcomᚋghjmᚋconnectopusᚋpkgᚋcpctlᚐNetnsFilter(ctx, tmp)
	}
...
func (ec *executionContext) unmarshalONetnsFilter2ᚖgithubᚗcomᚋghjmᚋconnectopusᚋpkgᚋcpctlᚐNetnsFilter(ctx context.Context, v interface{}) (*NetnsFilter, error) {
	if v == nil {
		return nil, nil
	}
